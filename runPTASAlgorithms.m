% Compares various PTAS algorithms: nearest neighbor (greedy point to
% point) in MATLAB and CPP, alternating algorithm in CPP, nearest neighbor
% with line fitting (greedy line to line).
%
% David Goodman
% 2015.09.12
...
waypointList = {[3,0; 5,0; 7,0; 9,0; 3,-2; 5,-2; 7,-2; 3,-4]*49};
...
for k=1:scenarioCount
    ...
    fig = plotWaypointScenario(V, [], subplotDim, 1, titleStr, opts);
    ...
    hAx = plotWaypointScenario(V, E, subplotDim, 2, titleStr, opts);
